...
import com.example.fethi.sinavzauygulama.ogretmen.ogretmenFragments.danismanOgretmenTAB.danismanOgrencilerim.OgretmenDanOgrenciBilgilerFragment;
...
public class
OgretmenBraOgrencilerimFragment extends Fragment implements SwipeRefreshLayout.OnRefreshListener  {
    ...
    public void parseJSON_1() {
        ...
        JsonObjectRequest objectRequest = new JsonObjectRequest(
                Request.Method.GET,
                Islevsel.ogretmenSiniflarOdevOnayURL,
                new JSONObject(),
                new Response.Listener<JSONObject>() {
                    @Override
                    public void onResponse(final JSONObject response) {
