...
import com.example.fethi.sinavzauygulama.veli.veliAdapters.VeliExpLVAdapterCozulenler;

import java.util.ArrayList;
import java.util.HashMap;
import java.util.List;

public class VeliCozulenlerFragment extends Fragment {

    public List<String> list_parent;
    public VeliExpLVAdapterCozulenler expand_adapter;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.v_fragment_cozulenler,container,false);
        ...
        expand_adapter = new VeliExpLVAdapterCozulenler(getActivity(), list_parent, list_child);
        expandlist_view_cozulenler.setAdapter(expand_adapter);  // oluşturduğumuz adapter sınıfını set ediyoruz
        ...
        expandlist_view_cozulenler.setOnGroupExpandListener(new ExpandableListView.OnGroupExpandListener() {//bir child açıldığında diğerlerini kapat
            @Override
            public void onGroupExpand(int groupPosition) {  //en fazla bir parentı aç
                if (last_position != -1 && last_position != groupPosition) {
                    expandlist_view_cozulenler.collapseGroup(last_position);
                }
    ...
    public void Hazırla() {
        ...
        list_parent.add("Geometri");  // ilk başlığı giriyoruz
        ...
        turkce_list.add("Geometri Kitap 1");
        turkce_list.add("Geometri Kitap 2");
        turkce_list.add("Geometri Kitap 3");
        turkce_list.add("Geometri Kitap 4");
