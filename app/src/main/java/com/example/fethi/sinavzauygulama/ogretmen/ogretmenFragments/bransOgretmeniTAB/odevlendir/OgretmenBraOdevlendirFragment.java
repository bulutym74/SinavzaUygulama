...
public class OgretmenBraOdevlendirFragment extends Fragment implements SwipeRefreshLayout.OnRefreshListener {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        fab_odevlendir.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                OgretmenBraKitapSecFragment nextFrag = new OgretmenBraKitapSecFragment();
                nextFrag.seciliSiniflar = new ArrayList<>();
