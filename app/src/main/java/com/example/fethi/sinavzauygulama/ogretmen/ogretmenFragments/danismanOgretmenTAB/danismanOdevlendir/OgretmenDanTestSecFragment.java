...
public class OgretmenDanTestSecFragment extends Fragment implements SwipeRefreshLayout.OnRefreshListener {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        expand_adapter = new OgretmenExpLVAdapterTestSec(getActivity(),seciliKitap.getKonular(),this,1);
