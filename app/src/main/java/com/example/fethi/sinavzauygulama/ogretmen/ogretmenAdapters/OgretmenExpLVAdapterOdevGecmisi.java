...
public class OgretmenExpLVAdapterOdevGecmisi extends BaseExpandableListAdapter {

    ArrayList<DersItem> dersler;
    public Context context;
    public LayoutInflater inflater;

    public OgretmenExpLVAdapterOdevGecmisi(Context context, ArrayList<DersItem> dersler)
    {
