...
public class VeliExpLVAdapterYapilmamisOdevler extends BaseExpandableListAdapter {
    ...
    public VeliExpLVAdapterYapilmamisOdevler(Context context, List<String> list_parent, HashMap<String, List<String>> list_child)
    {
    ...
    public View getGroupView(int groupPosition, boolean isExpanded, View view, ViewGroup parent) {
        ...
        if(view == null)
        {
            ...
            view = inflater.inflate(R.layout.v_listview_header_yapilmamis_odevler,null);
        }
    ...
    public View getChildView(int groupPosition, int childPosition, boolean isLastChild, View view, ViewGroup parent) {
        ...
        {
            inflater = (LayoutInflater)context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
            view = inflater.inflate(R.layout.v_listview_child_yapilmamis_odevler, null);
