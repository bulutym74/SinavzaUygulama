...
import com.example.fethi.sinavzauygulama.ogrenci.ogrenciAdapters.ExpLVAdapterYapilmamisOdevler;
...
public class YapilmamisOdevlerFragment extends Fragment implements SwipeRefreshLayout.OnRefreshListener {

    ArrayList<DersItem> dersler = new ArrayList<>();

    public ExpLVAdapterYapilmamisOdevler expand_adapter;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_yapilmamis_odevler, container, false);
        ...
        expand_adapter = new ExpLVAdapterYapilmamisOdevler(getActivity(), dersler);
        ...
        expandlist_view_odevler.setOnChildClickListener(new ExpandableListView.OnChildClickListener() {
            ...
            public boolean onChildClick(ExpandableListView parent, View v, int groupPosition, int childPosition, long id) {
                ...
                YapilmamisKonularFragment nextFrag = new YapilmamisKonularFragment();
