...
public class OgrenciUyeOlKurumsuzFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.a_fragment_ogrenci_uyeol_kurumsuz, container, false);
        ...
        adapter = new OgrenciSinifSecAdapter(siniflar, getContext(), this, 1);
                                ...
                                try {
                                    if (response.getBoolean("isFailed")) {
                                        ...
                                        if (ogretmeneBagli) {
                                            ...
                                            Intent intent = new Intent(getActivity(), OgrenciAnasayfaActivity.class);
                                            startActivity(intent);
                                        }
